...
<br><right>— LJXH's signature of personality</right>
:::
...
This website is a blog created based on the **Momo** theme of **Astro**. Open source links are below:
...
This website is deployed on **Cloudflare Pages** and is managed in the backend using **Pages CMS**.
...
- **Programming**:`Python`、`C++`、`HTML`、`CSS`、`JavaScript`、`Java` 
- **Software**:`Can use Windows and Android proficiently`, `Have tried Linux`, `Can skillfully install and uninstall major software`, `Can unzip files`, `Proficient in using Office`
